...
O processo do DSH é spawnado **antes** do `set -Ux` do fish ser exportado, então a ferramenta bash (que é `/bin/bash`, não fish) **não enxerga** as variáveis universais diretamente.
